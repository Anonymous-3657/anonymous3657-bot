...
from routers import (admin, admin_advanced, ai, auth_routes, catalog, comments,  # noqa: E402
                     exams, meta, notifications, pdfs, profile, public, ratings,
...
api_router.include_router(admin_advanced.router)
